...
<html lang="zh-CN">
  ...
  <body>
    ...
    <script type="text/javascript">
        $(function () {
        	$('#RStartDateSel').datetimepicker();
            $('#REndDateSel').datetimepicker({
                useCurrent: false //Important! See issue #1075
            });
            $("#RStartDateSel").on("dp.change", function (e) {
                $('#REndDateSel').data("DateTimePicker").minDate(e.date);
            });
            $("#REndDateSel").on("dp.change", function (e) {
                $('#RStartDateSel').data("DateTimePicker").maxDate(e.date);
            });
        });
    </script>
  </body>
