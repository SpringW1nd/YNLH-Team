	...
	<div class="container-fluid outer" >
		...
		<div class="row">
			...
			<div class="panel panel-default" style="height: 100%;">
				<div class="panel-heading">Parking Space List</div>
					...
					<div class="row" style="margin:15px 0 0 0; ">
						<table class="table table-hover">
							...
							<c:forEach var="item" items="${resultList}">
								<tr>
									<td><a href="manager/parkingSpaceDetail?parkNumber=<c:out value="${item.parkNumber}"></c:out>"><c:out value="${item.parkNumber}"></c:out></a></td>
