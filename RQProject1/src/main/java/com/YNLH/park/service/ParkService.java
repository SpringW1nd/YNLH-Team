...
public interface ParkService {
	...
	public List<RegisterPlateNumber> listRegisterPlateNumber(int uid);	//List all PlateNumbers of a user
	...
	public List<RegisterBill> listRegisterBill(int uid);		//List all bill of one user
