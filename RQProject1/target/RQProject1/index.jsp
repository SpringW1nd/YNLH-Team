  ...
  <head>
    ...
    <%
		...
		String basePath = request.getScheme() + "://"
	        ...
	        + path + "/";
		String LoginFlag = request.getAttribute("LoginFlag") == null? "1":"0";
	%>
	<base href="<%=basePath%>"></base>
    <title>YNLH Parking Project</title>
    <!-- Bootstrap -->
	...
	<div class="container-fluid outer" >
		...
		%>
			<div class="alert alert-danger alert-dismissible" role="alert" style="margin-bottom: 0;">
 				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  				<strong>Error!</strong>  Unknown problems with user login!
			</div>	
		<%	
		...
		%>
			<div class="alert alert-warning alert-dismissible" role="alert" style="margin-bottom: 0;">
 				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  				<strong>Warning!</strong>  Please Check your password or username!
			</div>
		<%	
